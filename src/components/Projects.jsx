...
const Projects = () => {
  return (
    <div
      id="projects"
      className="border-[1px] border-[#282828] rounded-[30px] p-5 mt-4 pb-4 "
    >
      <motion.h2
          ...
          >
            ...
            >
              ...
              <a
                target="_blank"
                href={project.link}
                className="flex gap-2 items-center text-[#A2A2A2] mb-2 "
              >
                <FaGithub />
                Github
              </a>

              {/* <a href={project.deploymentlink} className=" flex gap-2 items-center text-[#A2A2A2]"><RxVercelLogo/>Live</a> */}
